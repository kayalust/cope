...
import rip.kaya.placeholders.command.api.annotation.Duration;
import rip.kaya.placeholders.command.api.annotation.Sender;
import rip.kaya.placeholders.command.api.annotation.Text;
import rip.kaya.placeholders.command.api.argument.ArgumentParser;
import rip.kaya.placeholders.command.api.argument.CommandArgs;
import rip.kaya.placeholders.command.api.exception.*;
import rip.kaya.placeholders.command.api.modifier.DrinkModifier;
import rip.kaya.placeholders.command.api.modifier.ModifierService;
import rip.kaya.placeholders.command.api.parametric.BindingContainer;
import rip.kaya.placeholders.command.api.parametric.DrinkBinding;
import rip.kaya.placeholders.command.api.parametric.DrinkProvider;
import rip.kaya.placeholders.command.api.parametric.ProviderAssigner;
import rip.kaya.placeholders.command.api.parametric.binder.DrinkBinder;
import rip.kaya.placeholders.command.api.provider.*;
import rip.kaya.placeholders.command.api.provider.spigot.CommandSenderProvider;
import rip.kaya.placeholders.command.api.provider.spigot.ConsoleCommandSenderProvider;
import rip.kaya.placeholders.command.api.provider.spigot.PlayerProvider;
import rip.kaya.placeholders.command.api.provider.spigot.PlayerSenderProvider;
