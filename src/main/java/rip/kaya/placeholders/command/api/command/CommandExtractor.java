...
import rip.kaya.placeholders.command.api.annotation.Command;
import rip.kaya.placeholders.command.api.annotation.Require;
import rip.kaya.placeholders.command.api.exception.CommandRegistrationException;
import rip.kaya.placeholders.command.api.exception.CommandStructureException;
import rip.kaya.placeholders.command.api.exception.MissingProviderException;
