package rip.kaya.placeholders.command.api.argument;

import com.google.common.base.Preconditions;
import rip.kaya.placeholders.command.api.annotation.Flag;
import rip.kaya.placeholders.command.api.command.CommandExecution;
import rip.kaya.placeholders.command.api.command.CommandFlag;
import rip.kaya.placeholders.command.api.command.DrinkCommand;
import rip.kaya.placeholders.command.api.command.DrinkCommandService;
import rip.kaya.placeholders.command.api.exception.CommandArgumentException;
