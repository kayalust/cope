package rip.kaya.placeholders.command.api;

import org.bukkit.plugin.java.JavaPlugin;
import rip.kaya.placeholders.command.api.command.DrinkAuthorizer;
import rip.kaya.placeholders.command.api.command.DrinkCommandContainer;
